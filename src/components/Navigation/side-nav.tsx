...
const SideNav = () => {
  return (
    <div className='md:w-60 h-screen flex-1 fixed border-r border-card hidden md:flex'>
      ...
      {item.submenu ? (
        <>
          <button
            ...
            className={`flex flex-row items-center p-2 rounded-lg hover-bg-secondary w-full justify-between hover:bg-secondary ${
